...
export default function HaveCard({ have, removeHave }) {
    ...
    return (
        <div className='bg-[#ECF0F1] mb-6'>
            ...
            <button className="inline-block px-6 py-2.5 bg-red-400 text-white font-bold text-xs leading-tight uppercase rounded-full shadow-md hover:bg-gray-300 hover:shadow-lg focus:bg-gray-300 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-gray-400 active:shadow-lg transition duration-150 ease-in-out" onClick={handleDelete}>Delete</button>
            </div>
        </div>
    )
}
